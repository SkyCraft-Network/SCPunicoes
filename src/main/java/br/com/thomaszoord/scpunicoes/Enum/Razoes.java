...
public enum Razoes {
    ANTIJOGO("Antijogo",
            "Praticar uma conduta que prejudique a \n" +
                    "experiência de jogo de outros jogadores. \n",
    ...
    AMEACA("Ameaça",
            "Proferir ameaças graves a \n " +
                    "jogadores ou membros da equipe \n",
    ...
    DISCURSO_DE_ODIO("Discurso de Ódio",
            "Proferir de ofensas discriminatórias \n" +
                    "a fim de diminuir outro jogador. \n",
            TipoPunicao.PERMANENTE, Duration.ZERO, true),

    DISCRIMINACAO("Discriminação",
            "Usar de informações erradas para \n " +
                    "tentar ludibriar outros jogadores \n",
            TipoPunicao.PERMANENTE, Duration.ZERO, false),

    COMERCIO("Comércio",
            "Comerciar itens in-game ou off-game usando \n" +
                    "o servidor como plataforma de venda. \n",
            TipoPunicao.MUTE, Duration.ofDays(1),
            TipoPunicao.BAN, Duration.ofDays(1),
    ...
    DIVULGACAO_GRAVE("Divulgação grave",
            "Divulgar sites, servidores e \n" +
                    "afins sem autorização da equipe. \n",
            TipoPunicao.MUTE, Duration.ofHours(12),
            TipoPunicao.MUTE, Duration.ofDays(1),
            TipoPunicao.BAN, Duration.ofDays(3),
            TipoPunicao.BAN, Duration.ofDays(7),true),
    ...
    DIVULGACAO_SIMPLES("Divulgação simples",
            "Divulgar redes sociais sem \n " +
                    "a permissão da equipe \n",
            TipoPunicao.MUTE, Duration.ofHours(12),
            TipoPunicao.MUTE, Duration.ofDays(1),
            TipoPunicao.BAN, Duration.ofDays(3),
            TipoPunicao.BAN, Duration.ofDays(7),true),
    ...
    CHARGEBACK("Chargeback",
            "Cancelar o pagamento de um pacote da loja a \n " +
                    "fim de obter o produto gratuitamente. \n",
            TipoPunicao.PERMANENTE, Duration.ZERO, false),

    FALSIFICACAO_PROVAS("Falsificação de provas",
            "Falsificar provas a fim de punir \n " +
                    "outro jogador de forma injusta. \n",
            TipoPunicao.BAN, Duration.ofDays(180),
            TipoPunicao.PERMANENTE, Duration.ZERO, false),
    USO_MOD_NAO_PERMITIDO("Uso de mod não permitido",
            "Usar modificações do Minecraft \n" +
                    "ou clientes não permitidos \n",
            TipoPunicao.BAN, Duration.ofDays(3),
            TipoPunicao.BAN, Duration.ofDays(7),
            TipoPunicao.BAN, Duration.ofDays(30),
            TipoPunicao.BAN, Duration.ofDays(180), false),
    FLOOD_SPAM("Flood/Spam",
            "Usar de mensagens repetidas ou caracteres \n" +
                    "excessivos para prejudicar o chat. \n",
    ...
    USO_HACK("Uso de Hack",
            "Fazer uso de clients e/ou programas ilícitos \n" +
                    "a fim de obter vantagens in-game. \n",
            TipoPunicao.BAN, Duration.ofDays(180), false),
    NICKNAME_INAPROPRIADO_ORIGINAL("Nickname inapropriado (original)",
            "Usar um nickname ofensivo e/ou \n " +
                    "inadequado com as diretrizes do servidor \n",
            TipoPunicao.BAN, Duration.ofDays(30),false),
    ...
    OFENSA_JOGADOR("Ofensa a jogador",
            "Proferir ofensas e/ou \n desrespeitar outros jogadores \n",
            TipoPunicao.MUTE, Duration.ofHours(6),
            TipoPunicao.MUTE, Duration.ofHours(12),
            TipoPunicao.BAN, Duration.ofDays(3),
            TipoPunicao.BAN, Duration.ofDays(7), true),
    OFENSA_EQUIPE_SERVIDOR("Ofensa à equipe/servidor",
            "Proferir ofensas e/ou desrespeitar membros da \n" +
                    "equipe ou o servidor como um todo. \n",
            TipoPunicao.MUTE, Duration.ofDays(1),
            TipoPunicao.BAN, Duration.ofDays(7),
            TipoPunicao.BAN, Duration.ofDays(15), true),
    SKIN_INAPROPRIADA("Skin inapropriada",
            "Usar uma skin ofensiva e/ou \n " +
                    "inadequada com as diretrizes do servidor \n",
    ...
    ASSEDIO("Assédio",
            "Assediar verbalmente um jogador.",
            TipoPunicao.BAN, Duration.ofDays(90),
            TipoPunicao.BAN, Duration.ofDays(180),
            TipoPunicao.PERMANENTE, Duration.ZERO, true),

    ABUSO_BUGS("Abuso de Bugs",
            "Usar de um bug a fim de de conseguir \n" +
                    "vantagens in-game \n",
            TipoPunicao.BAN, Duration.ofDays(3),
            TipoPunicao.BAN, Duration.ofDays(7),
            TipoPunicao.BAN, Duration.ofDays(15),
    ...
    FORMACAO_TIMES("Formação de times",
            "Formar times com outros jogadores. \n",
